import { Box, Button, Card, CardActions, CardContent, Grid, makeStyles, Collapse, TableBody, Toolbar, Typography } from '@material-ui/core';
      ...
      <Toolbar />
        <Box className={classes.box}>
          ...
          <Grid spacing={4} container>
            {artist ? artist.map((v, index) => (
              <Grid className={classes.teste} key={index} item>
                <Card className={classes.card}>
                  <CardContent>
                    ...
                    <Typography variant="body2" component="p">
                      {expanded ? v.description : v.description.substring(0, 100) + "..."}
                    </Typography>
                  </CardContent>
                  <CardActions>
        ...
        <Box className={classes.box}>
          ...
          <Grid spacing={4} container>
            {streaming ? streaming.map((v, index) => (
              <Grid className={classes.teste} key={index} item>
                <Card className={classes.card}>
                  <CardContent>
                    <Typography variant="h5" component="h2">
